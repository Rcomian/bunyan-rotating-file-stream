...
// There is an annoying bug where setImmediate sometimes doesn't fire. Fixed in node v5
var nextTick = semver.gt(process.version, '5.0.0') ? setImmediate : function (next) { setTimeout( next, 0); };
